...
import { splitSlideRequestSchema } from "@/lib/schemas/api-requests";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    logServerError("api/ai/split-slide", err);
    return apiError("internal_error", "Não foi possível dividir o slide.", 500);
  }
}
